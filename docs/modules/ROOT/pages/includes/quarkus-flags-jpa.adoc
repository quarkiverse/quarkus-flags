...
a|icon:lock[title=Fixed at build time] [[quarkus-flags-jpa_quarkus-security-jpa-persistence-unit-name]] [.property-path]##link:#quarkus-flags-jpa_quarkus-security-jpa-persistence-unit-name[`quarkus.security-jpa.persistence-unit-name`]##
